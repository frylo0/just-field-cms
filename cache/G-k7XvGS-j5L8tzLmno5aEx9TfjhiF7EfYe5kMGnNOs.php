...
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['class' => 'p1'], ['class' => 'db']), [[false, 'Open'], [false, './dev.php?page=field&view=tree&path=' . (isset($loc_path) ? $loc_path : null) . '&curr_path_i=' . (isset($path_i) ? $path_i : null)]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
...
$__pug_mixins['item_T_field'] = function ($block, $attributes, $__pug_arguments, $__pug_mixin_vars, $__pug_children) use (&$__pug_mixins, &$pugModule) {
    ...
    global $glo; ?><?php $path = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'path') ?><?php $attach = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'attach') ?><?php if (method_exists($_pug_temp = (isset($child) ? $child : null), "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><tr<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['data-item-id' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-id', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'id'))], ['data-item-type' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-type', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'type', 'name'))], ['class' => 'item_T_field'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'order'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'key'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input key...'], ['value' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('value', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'key'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'name'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input name...'], ['value' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('value', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'name'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'type'], ['colspan' => '2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'type', 'name')) ? var_export($_pug_temp, true) : $_pug_temp)) ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'value'], ['class' => 'w100'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input value...'], ['value' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('value', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'value'))])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>edit</td></tr><?php } else { ?><tr<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['data-item-id' => '{id}'], ['data-item-type' => '{type}'], ['class' => 'item_T_field'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'order'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'key'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input key...'], ['value' => '{key}'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'name'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input name...'], ['value' => '{name}'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'type'], ['colspan' => '2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>{type}</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'value'], ['class' => 'w100'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input value...'], ['value' => '{value}'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>{permission}</td></tr><?php } ?><?php
}; ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
...
$__pug_mixins[$__pug_mixin_name](false, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['class' => 'p1'], ['class' => 'db']), [[false, 'Open'], [false, './dev.php?page=field&view=tree&path=' . (isset($loc_path) ? $loc_path : null) . '&curr_path_i=' . (isset($path_i) ? $path_i : null)]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><?php
}); ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>edit</td></tr><?php } else { ?><tr<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['data-item-id' => '{id}'], ['data-item-type' => '{type}'], ['class' => 'item_T_list'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'order'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'key'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input key...'], ['value' => '{key}'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'name'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['placeholder' => 'Input name...'], ['value' => '{name}'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'type'], ['colspan' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>{type}</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'subtype'], ['colspan' => '1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>{subtype}</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'value'], ['class' => 'w100'], ['class' => 'p0'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php $path_i = $GLOBALS['__jpv_plus']((function_exists('count') ? count($path_parts) : $count($path_parts)), 1) ?><?php $loc_path = null ?><?php if (method_exists($_pug_temp = (isset($path) ? $path : null) == '', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php $loc_path = '{key}' ?><?php } else { ?><?php $loc_path = '' . $path . '/{key}' ?><?php } ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
...
$__pug_mixins[$__pug_mixin_name](false, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['class' => 'item_T_image__upload-button']), [[false, 'Upload'], [false, 'dark']], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><?php
}); ?><form<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'dn'], ['class' => 'item_T_image__file-form'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['type' => 'file'], ['name' => 'image'], ['accept' => 'image/*'], ['class' => 'item_T_image__file'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></form></div></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>edit</td></tr><?php } ?><?php
}; ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixins['item_T_space'] = function ($block, $attributes, $__pug_arguments, $__pug_mixin_vars, $__pug_children) use (&$__pug_mixins, &$pugModule) {
    ...
    global $glo; ?><?php $path = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'path') ?><?php $attach = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'attach') ?><?php if (method_exists($_pug_temp = (isset($child) ? $child : null), "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><tr<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['data-item-id' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-id', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'id'))], ['data-item-type' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-type', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'type', 'name'))], ['class' => 'item_T_space'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'order'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'key'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'type'], ['colspan' => '2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'value'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td></tr><?php } else { ?><tr<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['data-item-id' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-id', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'id'))], ['data-item-type' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('data-item-type', $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'type', 'name'))], ['class' => 'item_T_space'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'order'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'key'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'name'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'type'], ['colspan' => '2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colname' => 'value'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'], ['colname' => 'permission'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></td></tr><?php } ?><?php
}; ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
...
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, (isset($global) ? $global : null)]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><?php
}); ?><?php if (!$GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($_GET, 'view')) { ?><?php (function_exists('header') ? header('Location: ./dev.php?page=field&view=tree') : $header('Location: ./dev.php?page=field&view=tree')) ?><?php } ?><?php require_once $php . '/JustField.php'; ?>
...
$__pug_mixins[$__pug_mixin_name](false, array(  ), [], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><?php
}); ?></template><?php $is_data = true ?><table<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['data-update-link' => './dev.php?page=scripts&amp;script=field-update'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><thead><tr><td>Order</td><td>Key</td><td>Name</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['colspan' => '2'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Type</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Value</td><td>Permission</td></tr></thead><tbody><?php $children = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($db, 'at_path')($path) ?><?php $children = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($children, 'get_children')() ?><?php if (method_exists($_pug_temp = (isset($children) ? $children : null) == null, "__toBoolean")
        ? $_pug_temp->__toBoolean()
...
$__pug_mixin_name = 'button';
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](true, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['class' => 'page_button-add'], ['class' => 'rel'], ['data-add-link' => './dev.php?page=scripts&amp;script=field-add']), [[false, 'Add'], [false, 'dark']], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
    ...
    ?><div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'page_button-add__content'], ['class' => 'abs'], ['class' => 'col'], ['class' => 'top0'], ['class' => 'left0'], ['class' => 'dn'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php $types_orm = $GLOBALS['__jpv_dotWithArrayPrototype']($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($orm, 'from')('type'), 'select')('*') ?><?php $types = (function_exists('types_orm') ? types_orm() : $types_orm()) ?><?php $__eachScopeVariables = ['curr_type' => isset($curr_type) ? $curr_type : null];foreach ($types as $curr_type) { ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
foreach (array_keys(get_defined_vars()) as $__local_pug_key) {
...
$__pug_mixin_name = 'button';
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](true, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['class' => 'page_button-delete'], ['data-delete-link' => './dev.php?page=scripts&amp;script=field-delete']), [[false, 'Delete'], [false, 'dark']], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
