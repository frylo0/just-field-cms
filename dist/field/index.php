...
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, 'Dashboard'], [false, './../main'], [false, ($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($global, 'page-name') == 'main')]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
...
$__pug_mixin_name = 'aside__item';
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, 'Fields'], [false, './../field'], [false, ($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($global, 'page-name') == 'field')]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
...
$__pug_mixin_name = 'aside__item';
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, 'Field types'], [false, './../field-type'], [false, ($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($global, 'page-name') == 'field-type')]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
...
$__pug_mixin_name = 'aside__item';
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, 'Accounts'], [false, './../account'], [false, ($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($global, 'page-name') == 'account')]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
...
$__pug_mixins[$__pug_mixin_name](false, array(  ), [], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><?php
}); ?><?php $global = array( 'page-name' => 'field', 'orm' => $orm, 'user' => null ) ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
foreach (array_keys(get_defined_vars()) as $__local_pug_key) {
...
$__pug_mixins[$__pug_mixin_name](true, $pugModule['Phug\\Formatter\\Format\\BasicFormat::merge_attributes'](['href' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('href', ((function_exists('query_update') ? query_update('view', 'type') : (isset($query_update) ? (isset($query_update) ? $query_update : null) : null)('view', 'type'))))], ['class' => 'tdn']), [[false, 'a'], [false, ($GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($_GET, 'view') == 'type' ? 'light' : 'dark')]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?>Type View<?php
        ...
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php $curr_path_i = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($_GET, 'curr_path_i') ?><?php } $curr_path_i = (function_exists('intval') ? intval($curr_path_i) : $intval($curr_path_i)) ?><?php $parts = (function_exists('explode') ? explode('/', $full_path) : $explode('/', $full_path)) ?><?php $path_parts = array(  ) ?><?php for ($i = 0; $i < $curr_path_i; $i++) { ?><?php (function_exists('array_push') ? array_push($path_parts, $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($parts, $i)) : $array_push($path_parts, $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($parts, $i))) ?><?php } $path = (function_exists('implode') ? implode('/', $path_parts) : $implode('/', $path_parts)) ?><?php if (method_exists($_pug_temp = (function_exists('count') ? count((isset($parts) ? $parts : null)) : (isset($count) ? $count : null)((isset($parts) ? $parts : null))) == $GLOBALS['__jpv_and'](1, function () use (&$parts) { return $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($parts, 0) == ''; }), "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php $parts = array(  ) ?><?php } (function_exists('array_unshift') ? array_unshift($parts, '/') : $array_unshift($parts, '/')) ?><?php $i = 0 ?><?php $__eachScopeVariables = ['part' => isset($part) ? $part : null];foreach ($parts as $part) { ?><?php $is_curr = ($i == $curr_path_i) ?><a<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['href' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('href', ((function_exists('query_update') ? query_update('curr_path_i', (isset($i) ? $i : null)) : (isset($query_update) ? $query_update : null)('curr_path_i', (isset($i) ? $i : null)))))], ['class' => 'page_path__part'], ['class' => 'tdn'], ['class' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('class', ((isset($is_curr) ? $is_curr : null) ? 'page_path__part_curr' : ''))])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?= htmlspecialchars((is_bool($_pug_temp = (isset($part) ? $part : null)) ? var_export($_pug_temp, true) : $_pug_temp)) ?></a><?php $i++ ?><?php }extract($__eachScopeVariables); ?></div><div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'page_content'], ['class' => 'ova'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php $is_data = true ?><table><thead><tr><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Order</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Key</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Name</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Type</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Value</td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>Permission</td></tr></thead><tbody><?php $children = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($db, 'at_path')($path) ?><?php $children = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($children, 'get_children')() ?><?php if (method_exists($_pug_temp = (isset($children) ? $children : null) == null, "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php $is_data = false ?><?php } else { ?><?php $__eachScopeVariables = ['child' => isset($child) ? $child : null];foreach ($children as $child) { ?><tr><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'], ['class' => 'page_table-order'], ['class' => 'row'], ['class' => 'jcc'], ['class' => 'aic'], ['class' => 'cup'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><img<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($attach) ? $attach : null) . '/Images/up-down.svg')], ['draggable' => 'false'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'key')) ? var_export($_pug_temp, true) : $_pug_temp)) ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'name')) ? var_export($_pug_temp, true) : $_pug_temp)) ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?= htmlspecialchars((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'type', 'name')) ? var_export($_pug_temp, true) : $_pug_temp)) ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php $path_i = $GLOBALS['__jpv_plus']((function_exists('count') ? count($path_parts) : $count($path_parts)), 1) ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
foreach (array_keys(get_defined_vars()) as $__local_pug_key) {
...
isset($__pug_mixins[$__pug_mixin_name]) && 
$__pug_mixins[$__pug_mixin_name](false, array(  ), [[false, 'Open'], [false, './../field/?view=tree&path=' . (isset($path) ? $path : null) . '' . $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($child, 'key') . '&curr_path_i=' . (isset($path_i) ? $path_i : null)]], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    foreach (array_keys($__pug_children_vars) as $__local_pug_key) {
        if (mb_substr($__local_pug_key, 0, 6) === '__pug_') {
            continue;
        }
    ...
    ?><?php
}); ?></td><td<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'p1'], ['class' => 'tac'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>edit</td></tr><?php }extract($__eachScopeVariables); ?><?php } ?></tbody></table><?php if (!(isset($is_data) ? $is_data : null)) { ?><h2<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'tac'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>>No data</h2><?php } ?></div><?php } elseif (method_exists($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($_GET, 'view') == 'type', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?>type<?php } ?><div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['class' => 'page_foot-panel'], ['class' => 'w100'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
foreach (array_keys(get_defined_vars()) as $__local_pug_key) {
...
$__pug_mixins[$__pug_mixin_name](true, array(  ), [[false, 'Delete'], [false, 'dark']], $__pug_mixin_vars, function ($__pug_children_vars) use (&$__pug_mixins, $__pug_children, $pug_vars, &$pugModule) {
    ...
    ?><span<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['style' => 'color: #6CF6FF88'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>> (<span>0</span>)</span><?php
}); ?></div></main></body><script<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](array(  ), ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', '' . (isset($link) ? $link : null) . '.bundle.js')])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></script></html>