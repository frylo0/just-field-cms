...
<?php
$user_info = $orm->from('account')->select('*')->where("id_account = '{$_SESSION['id']}'")()[0];?>
<?php
...
<html lang="en">
  ...
  <link href="../.././dist/field/field.css" rel="stylesheet"></head>
  <body class="row">
      ...
      <div class="page_content ova w100">
        <template id="template_T_field"><?php if (isset($child)) : ?>
          <tr class="item_T_field" data-item-id="<?= $child->id ?>" data-item-type="<?= $child->type->name ?>">
            <td class="page_table-order row jcc aic cup" colname="order"><img src="../Attach/Images/up-down.svg" draggable="false"></td>
...
<?php foreach ($types as $curr_type) : ?>
  ...
  <script src="../.././dist/field/field.bundle.js"></script></body>
</html>