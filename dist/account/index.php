...
<html lang="en">
  ...
  <link href="../account/account.bundle.css" rel="stylesheet"></head>
  <body class="row"><?php
$aside_width = 400;
    ...
    <aside class="aside rel" style="width: <?=$aside_width?>px">
      <div class="aside__content col jcsb">
        <div class="col">
          ...
          <a class="box p1 box_mode_light cud block_disabled aside__item w100 db tdn" href="./../account">Accounts
          </a>
...
<?php foreach ($accounts as $curr_account) : ?>
  ...
  <script src="../account/account.bundle.js"></script></body>
</html>