...
<html lang="en">
  <head>
    ...
    <title>Accounts | Just Field</title>
    <link rel="stylesheet" href="./account.bundle.css?ver=<?=$VER?>">
  ...
  <link href="../.././dist/account/account.css" rel="stylesheet"></head>
  <body class="row">
    <aside class="aside rel" style="width: <?=$_COOKIE['-jf_aside-width']?>px">
      <div class="aside__content col jcsb">
        <div class="col">
          ...
          <a class="box p1 box_mode_dark aside__item w100 db tdn" href="./../main">Dashboard
          </a>
...
<?php
$accounts = $orm->from('account')->select('*')();?><?php foreach ($accounts as $curr_account) : ?>
            <tr>
              <td class="page_table-order row jcc aic cup"><img src="../Attach/Images/up-down.svg" draggable="false"></td>
      ...
      <div class="page_foot-panel w100">
    ...
    <script src="<?=$LINK?>.bundle.js?ver=<?=$VER?>"></script>
  <script src="../.././dist/account/account.bundle.js"></script></body>
</html>