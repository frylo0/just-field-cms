...
$(document).ready(() => {
   $('form').on('submit', e => {
      ...
      $password.val(md5__WEBPACK_IMPORTED_MODULE_1___default()(password));
      return true;
   });
});
