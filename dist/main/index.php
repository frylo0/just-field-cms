...
<html lang="en">
  <head>
    ...
    <title>Main page | Just Field</title>
  ...
  <link href="../.././dist/main/main.css" rel="stylesheet"></head>
  <body class="row">
    <aside class="aside rel" style="width: <?=$_COOKIE['-jf_aside-width']?>px">
      <div class="aside__content col jcsb">
        <div class="col">
          ...
          <a class="box p1 box_mode_light cud block_disabled aside__item w100 db tdn" href="./../main">Dashboard
          </a>
    ...
    <main></main>
    <script src="./main.bundle.js?ver=<?=$VER?>"></script>
  <script src="../.././dist/main/main.bundle.js"></script></body>
</html>