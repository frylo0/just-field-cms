...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Just Field</title>
  ...
  <body class="row">
    ...
    <main class="box p1 box_mode_none">
      <div class="box p1 box_mode_gray box_disabled panel">
        <div class="mb1 panel__title"><strong>Version / Updates</strong></div>
        <button class="box p1 box_mode_dark button tal cup brad0">Check for updates
        </button>
      </div>
    </main>
  <script src="../dashboard/dashboard.bundle.js"></script></body>
</html>